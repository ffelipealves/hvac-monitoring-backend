...
from monitoring_backend.infra.http.routers import campus, air_conditioner, monitoring_unit, monitoring_payload, monitoring_system_type
...
def create_app() -> FastAPI:
    ...
    app.include_router(monitoring_payload.router)
    app.include_router(monitoring_system_type.router)
